...
- Macro variables for user, repo, and token.  
    !["Image of API call to GitHub with user-specific macros"](./Code/Images/Call_Macros.png)  
- Macro variable for time window.
    !["Image of time window macro variable and code using it"](./Code/Images/Time_Macro.png) 
- URLs that should be updated in JSON.
    !["Image of repository-specific URLs"](./Code/Images/JSON_URLs.png)
- URL for webhook accepting POST request.
    !["Image of where to specify Teams webhook URL"](./Code/Images/Webhook_URL.png)  
